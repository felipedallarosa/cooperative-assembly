...
@Configuration
public class VoteRabbitConfiguration {

    public static final String ROUTING_KEY_NAME = "cooperative-assembly.vote.message";

    public static final String QUEUE_NAME = "cooperative-assembly.vote.queue";

    public static final String DEAD_LETTER_QUEUE_NAME = "cooperative-assembly.vote.dead-letter.queue";
